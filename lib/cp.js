...
class CouchPotatoApi {
  ...
  getList(cleanParameters) {
    var url = `${process.env.SITE_URL}/couchpotato/api/${this.CPApiKey}/search`;
  ...
  checkExists() {
    var url = `${process.env.SITE_URL}/couchpotato/api/${this.CPApiKey}/movie.list`;
    var options = {
      uri: url,
      headers: {
        "Authorization": this.auth,
  ...
  addMovie(IMDB_ID) {
    var url = `${process.env.SITE_URL}/couchpotato/api/${this.CPApiKey}/movie.add`
    var options = {
      uri: url,
      form: {
        identifier: IMDB_ID
  ...
  listMedia(movie_title) {
    var url = `${process.env.SITE_URL}/couchpotato/api/${this.CPApiKey}/media.list`
    var listOptions = {
      uri: url,
      form: {
